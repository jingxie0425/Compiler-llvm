...
@globbbbbbbbbb = global i32 3, align 4
...
define void @pow4(i32* %x) #0 {
  ...
  call void @pow2_cloned(i32 %3)
  %4 = load i32* @globbbbbbbbbb, align 4
...
define i32 @polynomial(i32 %y) #0 {
  ...
  store i32 %4, i32* %p2, align 4
  %5 = load i32* %1, align 4
  call void @pow3_cloned(i32 %5)
  %6 = load i32* @globbbbbbbbbb, align 4
...
define i32 @second_polynomial(i32 %x) #0 {
  ...
  store i32 %x, i32* %1, align 4
  %2 = load i32* %1, align 4
  call void @pow3_cloned(i32 %2)
  %3 = load i32* @globbbbbbbbbb, align 4
  store i32 %3, i32* %p3, align 4
  %4 = load i32* %1, align 4
  call void @polynomial_cloned(i32 %4)
  %5 = load i32* @globbbbbbbbbb, align 4
...
define i32 @main() #0 {
  ...
  call void @polynomial_cloned(i32 %2)
  %3 = load i32* @globbbbbbbbbb, align 4
...
; Function Attrs: nounwind uwtable
define void @pow2_cloned(i32 %x) #0 {
  %1 = alloca i32, align 4
  store i32 %x, i32* %1, align 4
  %2 = load i32* %1, align 4
  %3 = load i32* %1, align 4
  %4 = mul nsw i32 %2, %3
  store i32 %4, i32* @globbbbbbbbbb, align 4
  call void @pop_direct_branch()
  ret void
}

; Function Attrs: nounwind uwtable
define void @pow3_cloned(i32 %x) #0 {
  %1 = alloca i32, align 4
  store i32 %x, i32* %1, align 4
  %2 = load i32* %1, align 4
  %3 = load i32* %1, align 4
  ...
  %5 = load i32* %1, align 4
  %6 = mul nsw i32 %4, %5
  store i32 %6, i32* @globbbbbbbbbb, align 4
  call void @pop_direct_branch()
  ret void
}

; Function Attrs: nounwind uwtable
define void @polynomial_cloned(i32 %y) #0 {
  %1 = alloca i32, align 4
  %p2 = alloca i32, align 4
  %p3 = alloca i32, align 4
  %p4 = alloca i32, align 4
  ...
  %16 = add nsw i32 %13, %15
  %17 = add nsw i32 %16, 1
  store i32 %17, i32* @globbbbbbbbbb, align 4
  call void @pop_direct_branch()
  ret void
}
